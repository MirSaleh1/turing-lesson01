...
public class IndustrialCity extends City {
    ...
    public  IndustrialCity(int id, String name, long population, boolean isCapital, double area,Counrty counrty,int numberOfFactories,String mainIndustry,double annualProductionVolume) {
